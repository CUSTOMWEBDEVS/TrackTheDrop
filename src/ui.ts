export const el:any={
  video:document.getElementById('video'),view:document.getElementById('view'),
...
export function bindSlider(sl:any,label:any,cb:any){const render=()=>{label.textContent=sl.value;cb();};sl.addEventListener('input',render);render();}